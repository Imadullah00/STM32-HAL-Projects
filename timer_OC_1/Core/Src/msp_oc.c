...
void HAL_TIM_OC_MspInit(TIM_HandleTypeDef *htim)
{
	...
	GPIO_InitTypeDef tim2OC_ch_gpios;
	 //1. enable the peripheral clock for the timer4 peripheral
	...
	tim2OC_ch_gpios.Pin = GPIO_PIN_12 ;
	tim2OC_ch_gpios.Mode = GPIO_MODE_AF_PP;
	tim2OC_ch_gpios.Pull = GPIO_NOPULL;
	tim2OC_ch_gpios.Speed = GPIO_SPEED_FREQ_LOW;
	tim2OC_ch_gpios.Alternate = GPIO_AF2_TIM4;
	HAL_GPIO_Init(GPIOD, &tim2OC_ch_gpios);

/*	tim2OC_ch_gpios.Pin = GPIO_PIN_11|GPIO_PIN_10;
	tim2OC_ch_gpios.Mode = GPIO_MODE_AF_PP;
	tim2OC_ch_gpios.Pull = GPIO_NOPULL;
	tim2OC_ch_gpios.Speed = GPIO_SPEED_FREQ_LOW;
